...
class Seasons {
  ...
  constructor() {
    // ✨ initialize whatever properties are needed
    this.seasonList = ['spring', 'summer', 'fall', 'winter'],
    this.seasonKey = 0
  }
  ...
  next() {
    // ✨ implement
    this.seasonKey = (this.seasonKey + 1) % 4
    return this.seasonList[this.seasonKey]
  }
}
...
class Car {
  ...
  drive(distance) {
    // ✨ implement
    const possibleMiles = this.gas * this.mpg
